...
function startNormalGame() {
	...
	connection.onmessage = (event) => {
		...
		if (canvas.getContext) {
			...
			if (json.paddle1_x && leftBar.x === 0)
				leftBar.x = json.paddle1_x;
			if (json.paddle2_x && rightBar.x === 0)
				rightBar.x = json.paddle2_x;
			...
			if (json.bar_width) {
				if (leftBar.width === 0)
					leftBar.width = json.bar_width;
				if (rightBar.width === 0)
					rightBar.width = json.bar_width;
			}
